...
var LIFECYCLE_INTERFACES = [utils_2.LifecycleInterfaces.DoCheck, utils_2.LifecycleInterfaces.OnChanges];
var LIFECYCLE_METHODS = [utils_2.LifecycleMethods.ngDoCheck, utils_2.LifecycleMethods.ngOnChanges];
...
var validateInterfaces = function (context, node) {
    var declaredLifecycleInterfaces = utils_2.getDeclaredLifecycleInterfaces(node);
    var hasConflictingLifecycle = LIFECYCLE_INTERFACES.every(function (lifecycleInterface) { return declaredLifecycleInterfaces.indexOf(lifecycleInterface) !== -1; });
...
var validateMethods = function (context, node) {
    var declaredLifecycleMethods = utils_2.getDeclaredLifecycleMethods(node);
    var hasConflictingLifecycle = LIFECYCLE_METHODS.every(function (lifecycleMethod) { return declaredLifecycleMethods.indexOf(lifecycleMethod) !== -1; });
    if (!hasConflictingLifecycle)
        return;
    var failure = exports.getFailureMessage({
