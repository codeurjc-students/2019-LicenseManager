...
var TemplateAccessibilityAltTextVisitor = (function (_super) {
    __extends(TemplateAccessibilityAltTextVisitor, _super);
    function TemplateAccessibilityAltTextVisitor() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    TemplateAccessibilityAltTextVisitor.prototype.visitElement = function (ast, context) {
        this.validateElement(ast);
        _super.prototype.visitElement.call(this, ast, context);
    };
    TemplateAccessibilityAltTextVisitor.prototype.validateElement = function (element) {
    ...
    TemplateAccessibilityAltTextVisitor.prototype.img = function (element) {
    ...
    TemplateAccessibilityAltTextVisitor.prototype.object = function (element) {
        var elementHasText = '';
    ...
    TemplateAccessibilityAltTextVisitor.prototype.area = function (element) {
        var hasLabelAttr = element.attrs.some(function (attr) { return attr.name === 'aria-label' || attr.name === 'aria-labelledby'; });
        var hasLabelInput = element.inputs.some(function (input) { return input.name === 'aria-label' || input.name === 'aria-labelledby'; });
        var hasAltAttr = element.attrs.some(function (attr) { return attr.name === 'alt'; });
        var hasAltInput = element.inputs.some(function (input) { return input.name === 'alt'; });
    ...
    TemplateAccessibilityAltTextVisitor.prototype.input = function (element) {
    ...
    return TemplateAccessibilityAltTextVisitor;
