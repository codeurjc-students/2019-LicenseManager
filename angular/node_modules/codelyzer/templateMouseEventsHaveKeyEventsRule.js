...
exports.Rule = Rule;
var TemplateMouseEventsHaveKeyEventsVisitor = (function (_super) {
    __extends(TemplateMouseEventsHaveKeyEventsVisitor, _super);
    function TemplateMouseEventsHaveKeyEventsVisitor() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    TemplateMouseEventsHaveKeyEventsVisitor.prototype.visitElement = function (el, context) {
        this.validateElement(el);
        _super.prototype.visitElement.call(this, el, context);
    };
    TemplateMouseEventsHaveKeyEventsVisitor.prototype.validateElement = function (el) {
    ...
    return TemplateMouseEventsHaveKeyEventsVisitor;
