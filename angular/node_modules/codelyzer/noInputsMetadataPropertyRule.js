...
var Rule = (function (_super) {
    ...
    Rule.metadata = {
        ...
        rationale: utils_1.dedent(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n      * It is easier and more readable to identify which properties in a class are ", ".\n      * If you ever need to rename the property associated with @", ", you can modify it in a single place.\n      * The metadata declaration attached to the directive is shorter and thus more readable.\n    "], ["\n      * It is easier and more readable to identify which properties in a class are ", ".\n      * If you ever need to rename the property associated with @", ", you can modify it in a single place.\n      * The metadata declaration attached to the directive is shorter and thus more readable.\n    "])), METADATA_PROPERTY_NAME, utils_2.Decorators.Input),
        ruleName: 'no-inputs-metadata-property',
        type: 'style',
        typescriptOnly: true
    };
    Rule.FAILURE_STRING = "Use @" + utils_2.Decorators.Input + " rather than the `" + METADATA_PROPERTY_NAME + "` metadata property (" + STYLE_GUIDE_LINK + ")";
    return Rule;
