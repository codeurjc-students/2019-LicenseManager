...
exports.Rule = Rule;
var TemplateBananaInBoxVisitor = (function (_super) {
    __extends(TemplateBananaInBoxVisitor, _super);
    function TemplateBananaInBoxVisitor() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    TemplateBananaInBoxVisitor.prototype.visitEvent = function (ast, context) {
        this.validateEvent(ast);
        _super.prototype.visitEvent.call(this, ast, context);
    };
    TemplateBananaInBoxVisitor.prototype.validateEvent = function (ast) {
    ...
    return TemplateBananaInBoxVisitor;
