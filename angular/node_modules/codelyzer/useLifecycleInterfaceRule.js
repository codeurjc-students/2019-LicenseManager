...
var validateClassDeclaration = function (context, node) {
    var declaredLifecycleInterfaces = utils_1.getDeclaredLifecycleInterfaces(node);
    ...
    for (var _i = 0, declaredMethods_1 = declaredMethods; _i < declaredMethods_1.length; _i++) {
        ...
        if (!utils_1.isLifecycleMethod(methodName))
            continue;
        var interfaceName = utils_1.getLifecycleInterfaceByMethodName(methodName);
        var isMethodImplemented = declaredLifecycleInterfaces.indexOf(utils_1.LifecycleInterfaces[interfaceName]) !== -1;
