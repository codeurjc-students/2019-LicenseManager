...
exports.Rule = Rule;
var PreferOnPushComponentChangeDetectionWalker = (function (_super) {
    __extends(PreferOnPushComponentChangeDetectionWalker, _super);
    function PreferOnPushComponentChangeDetectionWalker() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    PreferOnPushComponentChangeDetectionWalker.prototype.visitNgComponent = function (metadata) {
        this.validateComponent(metadata);
        _super.prototype.visitNgComponent.call(this, metadata);
    };
    PreferOnPushComponentChangeDetectionWalker.prototype.validateComponent = function (metadata) {
    ...
    return PreferOnPushComponentChangeDetectionWalker;
}(ngWalker_1.NgWalker));
