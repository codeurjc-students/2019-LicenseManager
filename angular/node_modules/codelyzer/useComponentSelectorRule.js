...
exports.Rule = Rule;
var UseComponentSelectorWalker = (function (_super) {
    __extends(UseComponentSelectorWalker, _super);
    function UseComponentSelectorWalker() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    UseComponentSelectorWalker.prototype.visitNgComponent = function (metadata) {
        this.validateComponent(metadata);
        _super.prototype.visitNgComponent.call(this, metadata);
    };
    UseComponentSelectorWalker.prototype.validateComponent = function (metadata) {
    ...
    return UseComponentSelectorWalker;
}(ngWalker_1.NgWalker));
