...
var TemplateAccessibilityTableScopeVisitor = (function (_super) {
    __extends(TemplateAccessibilityTableScopeVisitor, _super);
    function TemplateAccessibilityTableScopeVisitor() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    TemplateAccessibilityTableScopeVisitor.prototype.visitElement = function (ast, context) {
        this.validateElement(ast);
        _super.prototype.visitElement.call(this, ast, context);
    };
    TemplateAccessibilityTableScopeVisitor.prototype.validateElement = function (element) {
        if (element.name === 'th') {
            return;
        }
    ...
    return TemplateAccessibilityTableScopeVisitor;
