...
exports.curentOffset = 0;
var PATTERN = /\s*ngFor.*\s*trackBy\s*:|\[ngForTrackBy\]\s*=\s*['"].*['"]/;
var Rule = (function (_super) {
    ...
    Rule.prototype.apply = function (sourceFile) {
        exports.curentOffset = 0;
        return this.applyWithWalker(new ngWalker_1.NgWalker(sourceFile, this.getOptions(), { templateVisitorCtrl: TemplateUseTrackByFunctionVisitor }));
    };
    Rule.metadata = {
...
exports.Rule = Rule;
var TemplateUseTrackByFunctionTemplateVisitor = (function (_super) {
    __extends(TemplateUseTrackByFunctionTemplateVisitor, _super);
    function TemplateUseTrackByFunctionTemplateVisitor() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    TemplateUseTrackByFunctionTemplateVisitor.prototype.visitDirectiveProperty = function (prop, context) {
        this.validateDirective(prop, context);
        _super.prototype.visitDirectiveProperty.call(this, prop, context);
    };
    TemplateUseTrackByFunctionTemplateVisitor.prototype.validateDirective = function (prop, context) {
        ...
        if (PATTERN.test((context.codeWithMap.source || '').substr(exports.curentOffset))) {
            exports.curentOffset = endOffset;
            return;
        }
        context.addFailureFromStartToEnd(startOffset, endOffset, Rule.FAILURE_STRING);
    };
    return TemplateUseTrackByFunctionTemplateVisitor;
...
var TemplateUseTrackByFunctionVisitor = (function (_super) {
    ...
    function TemplateUseTrackByFunctionVisitor() {
        ...
        _this.visitors = new Set([
            new TemplateUseTrackByFunctionTemplateVisitor(_this.getSourceFile(), _this.getOptions(), _this.context, _this.templateStart)
        ]);
        return _this;
    }
