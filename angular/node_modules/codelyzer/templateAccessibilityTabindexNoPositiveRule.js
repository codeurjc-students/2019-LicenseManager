...
exports.Rule = Rule;
var TemplateAccessibilityTabindexNoPositiveVisitor = (function (_super) {
    __extends(TemplateAccessibilityTabindexNoPositiveVisitor, _super);
    function TemplateAccessibilityTabindexNoPositiveVisitor() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    TemplateAccessibilityTabindexNoPositiveVisitor.prototype.visitElement = function (ast, context) {
        this.validateElement(ast);
        _super.prototype.visitElement.call(this, ast, context);
    };
    TemplateAccessibilityTabindexNoPositiveVisitor.prototype.validateElement = function (element) {
    ...
    return TemplateAccessibilityTabindexNoPositiveVisitor;
