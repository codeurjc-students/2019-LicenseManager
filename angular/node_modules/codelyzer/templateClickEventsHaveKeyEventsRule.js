...
exports.Rule = Rule;
var TemplateClickEventsHaveKeyEventsVisitor = (function (_super) {
    __extends(TemplateClickEventsHaveKeyEventsVisitor, _super);
    function TemplateClickEventsHaveKeyEventsVisitor() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    TemplateClickEventsHaveKeyEventsVisitor.prototype.visitElement = function (el, context) {
        this.validateElement(el);
        _super.prototype.visitElement.call(this, el, context);
    };
    TemplateClickEventsHaveKeyEventsVisitor.prototype.validateElement = function (el) {
    ...
    return TemplateClickEventsHaveKeyEventsVisitor;
