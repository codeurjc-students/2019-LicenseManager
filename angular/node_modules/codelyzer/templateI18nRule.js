...
var is_not_null_or_undefined_1 = require("./util/is-not-null-or-undefined");
...
var Rule = (function (_super) {
    ...
    Rule.prototype.isEnabled = function () {
        ...
        var optionArgument = utils_1.arrayify(this.ruleArguments).filter(is_not_null_or_undefined_1.isNotNullOrUndefined);
...
exports.Rule = Rule;
var TemplateI18NAttrVisitor = (function (_super) {
    __extends(TemplateI18NAttrVisitor, _super);
    function TemplateI18NAttrVisitor() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    TemplateI18NAttrVisitor.prototype.getCheckOption = function () {
        return OPTION_CHECK_ID;
    };
    TemplateI18NAttrVisitor.prototype.visitAttr = function (ast, context) {
        this.validateAttr(ast, context);
        _super.prototype.visitAttr.call(this, ast, context);
    };
    TemplateI18NAttrVisitor.prototype.validateAttr = function (ast, context) {
        if (ast.name !== 'i18n')
            return;
    ...
    return TemplateI18NAttrVisitor;
}(basicTemplateAstVisitor_1.BasicTemplateAstVisitor));
var TemplateI18NTextVisitor = (function (_super) {
    __extends(TemplateI18NTextVisitor, _super);
    function TemplateI18NTextVisitor() {
    ...
    TemplateI18NTextVisitor.prototype.getCheckOption = function () {
        return OPTION_CHECK_TEXT;
    };
    TemplateI18NTextVisitor.prototype.visitBoundText = function (text, context) {
        this.validateBoundText(text, context);
        _super.prototype.visitBoundText.call(this, text, context);
    };
    TemplateI18NTextVisitor.prototype.visitElement = function (element, context) {
    ...
    TemplateI18NTextVisitor.prototype.visitText = function (text, context) {
        this.validateText(text, context);
        _super.prototype.visitText.call(this, text, context);
    };
    TemplateI18NTextVisitor.prototype.validateBoundText = function (text, context) {
    ...
    TemplateI18NTextVisitor.prototype.validateText = function (text, context) {
        if (this.visited.has(text))
            return;
        this.visited.add(text);
    ...
    return TemplateI18NTextVisitor;
}(basicTemplateAstVisitor_1.BasicTemplateAstVisitor));
var TemplateI18NVisitor = (function (_super) {
    __extends(TemplateI18NVisitor, _super);
    function TemplateI18NVisitor() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.visitors = [
            new TemplateI18NAttrVisitor(_this.getSourceFile(), _this.getOptions(), _this.context, _this.templateStart),
            new TemplateI18NTextVisitor(_this.getSourceFile(), _this.getOptions(), _this.context, _this.templateStart)
        ];
        return _this;
    }
    TemplateI18NVisitor.prototype.visit = function (node, context) {
        _super.prototype.visit.call(this, node, context);
    };
    TemplateI18NVisitor.prototype.visitAttr = function (ast, context) {
        this.validateAttr(ast);
        _super.prototype.visitAttr.call(this, ast, context);
    };
    TemplateI18NVisitor.prototype.visitBoundText = function (text, context) {
        this.validateBoundText(text);
        _super.prototype.visitBoundText.call(this, text, context);
    };
    TemplateI18NVisitor.prototype.visitElement = function (element, context) {
        this.validateElement(element);
        _super.prototype.visitElement.call(this, element, context);
    };
    TemplateI18NVisitor.prototype.visitText = function (text, context) {
        this.validateText(text);
        _super.prototype.visitText.call(this, text, context);
    };
    TemplateI18NVisitor.prototype.validateAttr = function (ast) {
        var _this = this;
    ...
    TemplateI18NVisitor.prototype.validateBoundText = function (text) {
        var _this = this;
        var options = this.getOptions();
        this.visitors
            .filter(function (v) { return options.indexOf(v.getCheckOption()) !== -1; })
    ...
    TemplateI18NVisitor.prototype.validateElement = function (element) {
        var _this = this;
        var options = this.getOptions();
        this.visitors
            .filter(function (v) { return options.indexOf(v.getCheckOption()) !== -1; })
    ...
    TemplateI18NVisitor.prototype.validateText = function (text) {
        var _this = this;
        var options = this.getOptions();
        this.visitors
            .filter(function (v) { return options.indexOf(v.getCheckOption()) !== -1; })
