...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Welcome to the example of Licensoft. Introduce your ExampleLicensoft serial:");
        ...
        while(typeLicense==null){
            ...
            typeLicense = licencheck.checkLicense(serial,"ExampleLicensoft");
