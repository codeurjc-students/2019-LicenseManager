	...
	[
	    {
	        ...
	        "expMonth": 2,
	        "expYear": 2022,
	        "fingerprint": "FBk04ODdEzhZTM9R",
	        "funding": "debit",
	        "id": "card_1Fm1zUJogRBbRU8OGu5msojF",
	        "iin": null,
	        "issuer": null,
	        "last4": "8210",
	        "metadata": {},
...
## Delete Card of User
- **URL**  
   `/api/user/{userName}/card/{cardStripeId}`
- **Method**  
   `DELETE`
- **Data Params**
Path Variables:
	* String tokenId => Token auto-generated by StripeElements that has Credit Card Information
    * String cardStripeId => Unique identifier of the card in Stripe
- **Required role**:  
    * User
